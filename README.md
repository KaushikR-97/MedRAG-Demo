...
- The database layer uses SQLAlchemy models and Alembic migrations for users, patient profiles, medical documents, consent grants, audit events, appointments, hospital resources, answer traces, and feature-specific records.
- The retrieval layer combines indexed clinical or patient-approved context with query routing, rewriting, ranking, evidence preparation, and source-aware response generation.
